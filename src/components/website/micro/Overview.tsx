...
useEffect(() => {
  ...
  return (
    <section ref={sectionRef} className='py-[50px] md:py-[100px] bg-[#FEF7F0]'>
        <div className='px-[7%]'>
        <h2 className="overview-animate font-montserrat text-[32px] leading-[60px] font-normal tracking-[1px] capitalize text-[#F0801B] text-center">
  Home to India’s Most Iconic Residential Lifestyle Experience
</h2>

       <p className="overview-animate font-montserrat my-[50px] text-[18px] leading-[35px] font-normal tracking-[1px] text-black text-center">
...
<button className="overview-animate font-montserrat text-[20px] font-medium tracking-[1px] border-b border-[#0E4194] uppercase text-[#0E4194] text-center block w-fit mx-auto">
  Download Brochure
</button>
